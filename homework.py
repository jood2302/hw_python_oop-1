...
# Author: Vasiliy Kovylin. Backend, Cohort 16, # Project: Sprint 2. Calculator calories/money (four classes).
# Yandex.Praktikum.Python developer.
...
def time_to_date(date: str) -> dt.date:
    """ Get string of date in format "dd.mm.yyyy" and
        return dt.date obj with this

    """
    tmp_date: List[str] = date.split('.')
    return dt.date(int(tmp_date[2]), int(tmp_date[1]), int(tmp_date[0]))
